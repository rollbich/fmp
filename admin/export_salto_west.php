...
function write_xml($json) {
	...
	$xmlroot->setAttribute("nom", "LFMMW");
	...
	$xmlcluster->setAttribute("nom", "LFMMCTAW");
	
	foreach($json->confs->ouest as $nbr_sector=>$config) {
