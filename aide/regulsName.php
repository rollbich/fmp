...
<article class="center">
    ...
    <ul>
        <li>LFMDA16M : ici 1 seul caractère en plus (le A)</li>
        <li>LFMDAR16 : ici 2 caractères (AR) pour compléter car on a rogné la période de la journée</li>
        <li>MDARR16A : ici 3 caractères (ARR) pour compléter car on a utilisé que 2 lettres pour coder le début</li>
    </ul>
