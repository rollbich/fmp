...
<head>
    ...
    <title>Sauve vols dans BDD</title>
	...
	<script type="text/javascript" src="../js/sauve_h20_occ.js"></script>
    ...
    <script>
      	document.addEventListener('DOMContentLoaded', async event => {
			...
			document.getElementById('bouton_stats').addEventListener('click', async e => {
				...
				new sauve_h20_occ("result", zone, start_day, end_day);
			});
      	});
    </script>
</head>
...
<h1>Sauve H20-Occ to BDD</h1>
<div id="help_frame" class="off">
	<h2>Help</h2>
	<p><span>Le bouton "Save"</span> :<br>Il affiche les stats sur la plage sélectionnée</p>
	<button class="help_close_button pointer">Close</button>
</div>
<ul class="menu">
	<li id="bouton_stats" class="pointer"><span>Save</span></li>
